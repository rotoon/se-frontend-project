...
async function loadCategories() {
  ...
  try {
    ...
    Utils.showError("categoriesContainer", "Unable to load categories");
  }
}
...
function createPlaceCard(place) {
  const currentLang = LanguageManager.getCurrentLanguage();
  const name =
    LanguageManager.translate(place.name) || place.name || "Unnamed Place";
  ...
  return `
        <div class="col-lg-4 col-md-6">
            <div class="attraction-card place-card">
